...
3. Donne des exemples de produits phytosanitaires pour illustrer tes réponses si nécessaire
3. Pour les produits phytosanitaires, mentionne toujours :
   - Le nom du produit
        ...
        <body>
            ...
            <div class="endpoint">
                ...
                <ul>
                    ...
                    <li><code>/chat/invoke</code> - Endpoint pour les requêtes POST</li>
                    <li><code>/chat/stream</code> - Endpoint pour le streaming</li>
